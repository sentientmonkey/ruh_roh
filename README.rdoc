...
RuRuh provides a quick and easy way to have nicely render error pages generated from your stack
...
This project is release under the MIT License. Have fun, and be excellent to each other.
